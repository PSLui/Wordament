package com.arist.wordament.view;

import com.arist.wordament.game.Game;
import com.arist.wordament.game.Board;
import com.arist.wordament.Synchronizer;
...
public class GameView extends View implements Synchronizer.Event {
	...
	private class FingerTracker {
		...
		FingerTracker(GameView v, Game g) {
			view = v;
			game = g;
